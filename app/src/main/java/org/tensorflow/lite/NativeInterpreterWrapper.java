...
public final class NativeInterpreterWrapper implements AutoCloseable {
  ...
  NativeInterpreterWrapper(String modelPath, int numThreads) {
	 Log.d("wwww", "NativeInterpreterWrapper modelPath== " +modelPath);
    errorHandle = createErrorReporter(ERROR_BUFFER_SIZE);
    Log.d("wwww", "NativeInterpreterWrapper errorHandle== " +errorHandle);
    modelHandle = createModel(modelPath, errorHandle);
    Log.d("wwww", "NativeInterpreterWrapper modelHandle== " +modelHandle);
    interpreterHandle = createInterpreter(modelHandle, errorHandle, numThreads);
    Log.d("wwww", "NativeInterpreterWrapper interpreterHandle== " +interpreterHandle);
